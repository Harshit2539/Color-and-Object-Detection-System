...
# Open the video capture with camera index 2
camera_index = 1
...
if not os.path.isfile(configPath) or not os.path.isfile(weightsPath):
...
print("Object Detection is working Properly.....")


# From Here the Color Detection code will be submerged
#------------------------------------
# This is the code for color detection
# We will use the HSV color space for this
# We will define the range of colors we want to detect
# We will use the inRange function to get the pixels that fall within the range
# We will then use the countNonZero function to get the number of pixels that fall within th
# We will use the threshold function to convert the image to binary
